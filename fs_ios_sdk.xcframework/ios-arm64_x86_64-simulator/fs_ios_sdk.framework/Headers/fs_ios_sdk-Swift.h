...
#ifndef FS_IOS_SDK_SWIFT_H
#define FS_IOS_SDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="fs_ios_sdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10fs_ios_sdk10FSFullGame")
...
SWIFT_CLASS("_TtC10fs_ios_sdk10FSMiniGame")
...
@interface FSMiniGame (SWIFT_EXTENSION(fs_ios_sdk)) <UIScrollViewDelegate>
